...
import {
  ...
  UpdateCancelOrder,
  CancelObject,
} from '../../types/history/cancelOrder';

const initialState: FetchHistory = [];

export const orderHistoryAsync = createAsyncThunk(
  'orderHistor/orderHistoryAsync',
  async (userId: string) => {
...
// CancelOrder型一時的にエラ〜
export const cancelOrderHistoryAsync = createAsyncThunk(
  'cancelOrderHistory/cancelOrderHistoryAsync',
  async (cancelStatus: any) => {
...
export const orderHistorySlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(
      orderHistoryAsync.fulfilled,
      (state, action: PayloadAction<FetchHistory>) => {
...
export const { cancelOrderStatus, logoutUserHistoryItems } =
