...
export const { setLocalCartStrage, deleteLocalCartStrage } =
  localCartStrageSlice.actions;

export const selectLocalCartStrage = (state: RootState) =>
  state.localCartStrage;
